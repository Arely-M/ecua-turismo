...
<body>
    ...
    <div class="gtco-testimonials" style="margin-top: 15rem;">
        ...
        <div class="owl-carousel owl-carousel1 owl-theme">
            <div>
                <div class="card text-center"><img class="card-img-top" src="img/nosotros/Denise Martinez_recortado.jpeg" alt="">
                    <div class="card-body">
            ...
            <div>
                <div class="card text-center"><img class="card-img-top" src="img/nosotros/Gustavo Hidalgo_recortado.jpeg" alt="">
                    <div class="card-body">
            ...
            <div>
                <div class="card text-center"><img class="card-img-top" src="img/nosotros/Bryan Camacho_recortado.jpeg" alt="">
                    <div class="card-body">
                        <h5>Bryan Camacho<br />
                            <span> Diseñador, Programador </span>
                        </h5>
