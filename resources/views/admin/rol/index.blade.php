        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
            <div class="p-4">
                <div class="w-100 mb-4 row justify-content-md-between">
                    <label class="h4">Lista de roles</label>
                    <a type="button" class="btn btn-success" href="rol/create">Ingresar</a>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="w-100 row justify-content-center">
                                            <a class="btn btn-primary mr-2" href="{{route('rol.edit', $rol)}}">Editar</a>
