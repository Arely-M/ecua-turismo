        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
            <div class="p-4">
                <div class="w-100 mb-4 row justify-content-md-between">
                    <label class="h4">Lista de permisos</label>
                    <a type="button" class="btn btn-success" href="permiso/create">Ingresar</a>
                </div>
                <!--Contenedor de listado de permisos-->
                @if($permisos->count())
                    <div>
                        <table id="permisos" class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="w-100 row justify-content-center">
                                            <a class="btn btn-primary mr-2" href="{{route('permiso.edit', $permiso)}}">Editar</a>
